...
export default function ServicesPage() {
  ...
  async function saveService() {
    ...
    if (
      !currentService.host_address ||
      !currentService.email_id ||
      !currentService.password
    ) {
      toast({
    ...
    try {
      ...
      toast({
        title: "Error",
        description: `Failed to ${dialogMode} service: ${
